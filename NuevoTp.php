<div id="inputC" style="border:1px solid #000; background-color:#FFF; box-shadow: 3px 3px 3px #888888; height:240px;">       
    ...
    <input type="text" id="tipo" name="tipo" maxlength="48" style="width:300px; height:25px;"  />
    </td>
    </tr> 
    ...
    <input type="text" id="tarifa" name="tarifa" style="width:100px; height:25px; text-align:right;"  />
    </td>
    </tr>          
    ...
    <input type="button" value="Guardar"  onclick="GuardarTp();" style="width:100px; height:30px; font-size:15px;"/>&nbsp;&nbsp;
